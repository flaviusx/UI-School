...
hbs = handlebars.create({
    ...
    helpers: {
            ...
            lorem_titlecase_word: function(){                
                return toTitleCase(lorem({count: 1, units: 'words'})); 
            },
            ...
            repeat: function(howManyTimes, options) {
                var content = "";
                for (var i = 0; i < howManyTimes; i++) {
                     // options.fn renders what is inside block and returns the text
